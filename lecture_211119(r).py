...
Original file is located at
    https://colab.research.google.com/drive/1APQ4E73z8unvLEzVcuZipAUdS31cXset
"""
...
uniform_init3 = tf.random_uniform_initializer(minval = -0.12, maxval = 0.12, seed = None)
uniform_init4 = tf.random_uniform_initializer(minval = -0.09, maxval = 0.09, seed = None)
uniform_init5 = tf.random_uniform_initializer(minval = -0.25, maxval = 0.25, seed = None)
mnistM = tf.keras.models.Sequential([
                                     ...
                                     tf.keras.layers.Dense(128, activation = 'relu', kernel_initializer= uniform_init3),
                                     tf.keras.layers.Dense(128, activation = 'relu', kernel_initializer= uniform_init4),
                                     tf.keras.layers.Dense(128, activation = 'sigmoid', kernel_initializer= uniform_init5)
...
mnistM.fit(x_train, y_train, epochs = 16, batch_size = 32)

mnistM.evaluate(x_test, y_test, verbose = 2)