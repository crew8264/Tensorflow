# -*- coding: utf-8 -*-
"""Lecture_211126.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fezpmsh7rnPtra9OO4NfCdZ87nZx9TY_
"""
...
# 학습하기 편한 객체로 변환, batch size를 32개로 지정
train_ds  = tf.data.Dataset.from_tensor_slices((x_train, y_train)).shuffle(1000).batch(32)
test_ds   = tf.data.Dataset.from_tensor_slices((x_test, y_test)).batch(32)

train_ds  = tfds.load('mnist', split = 'train[:2048]')
cnt = [x for x, y in enumerate(train_ds)][-1] + 1
print(cnt)
